...
function moveCodeSnippetsToXcodeSnippetsFolder {
    ...
    cp -a ./snippets/* ~/Library/Developer/Xcode/UserData/CodeSnippets/
}
...
function moveFileTemplatesToXcodeFileTemplatesFolder {
    ...
    cp -a ./filetemplete/Custom/* /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/Library/Xcode/Templates/File\ Templates/Custom/
}
